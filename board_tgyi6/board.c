  ...
  .ports = {
    {
      ...
      .pads = {
        ...
        /* PTA3*/ PAL_MODE_ALTERNATIVE_7,   /* PTA4*/ PAL_MODE_ALTERNATIVE_1,    /* PTA5*/ PAL_MODE_INPUT_ANALOG,
        ...
        /*PTA12*/ PAL_MODE_INPUT_ANALOG,    /*PTA13*/ PAL_MODE_ALTERNATIVE_1,    /*PTA14*/ PAL_MODE_INPUT_ANALOG,
    ...
    },
    {
      .port = IOPORT2,  // PORTB
      .pads = {
        /* PTB0*/ PAL_MODE_ALTERNATIVE_1,   /* PTB1*/ PAL_MODE_INPUT_ANALOG,    /* PTB2*/ PAL_MODE_INPUT_ANALOG,
    ...
    },
    {
      ...
      .pads = {
        ...
        /* PTC6*/ PAL_MODE_INPUT_ANALOG,    /* PTC7*/ PAL_MODE_INPUT_ANALOG,    /* PTC8*/ PAL_MODE_ALTERNATIVE_1,
        /* PTC9*/ PAL_MODE_ALTERNATIVE_1,   /*PTC10*/ PAL_MODE_ALTERNATIVE_1,   /*PTC11*/ PAL_MODE_ALTERNATIVE_1,
    ...
    },
    {
      .port = IOPORT4,  // PORTD
      .pads = {
        /* PTD0*/ PAL_MODE_INPUT_ANALOG,    /* PTD1*/ PAL_MODE_UNCONNECTED,    /* PTD2*/ PAL_MODE_INPUT_ANALOG,
        /* PTD3*/ PAL_MODE_INPUT_ANALOG,    /* PTD4*/ PAL_MODE_INPUT_ANALOG,    /* PTD5*/ PAL_MODE_INPUT_ANALOG,
        /* PTD6*/ PAL_MODE_INPUT_ANALOG,    /* PTD7*/ PAL_MODE_ALTERNATIVE_1,    /* PTD8*/ PAL_MODE_INPUT_ANALOG,
    ...
    },
    {
      ...
      .pads = {
        ...
        /*PTE18*/ PAL_MODE_ALTERNATIVE_1,   /*PTE19*/ PAL_MODE_ALTERNATIVE_1,   /*PTE20*/ PAL_MODE_ALTERNATIVE_1,
        /*PTE21*/ PAL_MODE_ALTERNATIVE_1,    /*PTE22*/ PAL_MODE_INPUT_ANALOG,    /*PTE23*/ PAL_MODE_INPUT_ANALOG,
        ...
        /*PTE30*/ PAL_MODE_ALTERNATIVE_1,    /*PTE31*/ PAL_MODE_ALTERNATIVE_1,
      },
    },
  },
};
...
//portd7, porte18, porte19 set slew rate slow
}
